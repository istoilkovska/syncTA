...
rules = []
rules.append({'idx': 0, 'from': 0, 'to': 2, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 1, 'from': 0, 'to': 3, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 2, 'from': 0, 'to': 4, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 (* 2 tb) to)) )"})
rules.append({'idx': 3, 'from': 0, 'to': 5, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 (* 2 tb) to)) )"})

rules.append({'idx': 4, 'from': 1, 'to': 2, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 5, 'from': 1, 'to': 3, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 6, 'from': 1, 'to': 4, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 (* 2 tb) to)) )"})
rules.append({'idx': 7, 'from': 1, 'to': 5, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 (* 2 tb) to)) )"})
...
# queen transitions
rules.append({'idx': 26, 'from': 12, 'to': 14, 'guard': "(<= nr1 nr0)"})
rules.append({'idx': 27, 'from': 12, 'to': 15, 'guard': "(> nr1 nr0)"})

rules.append({'idx': 28, 'from': 13, 'to': 14, 'guard': "(<= nr1 nr0)"})
rules.append({'idx': 29, 'from': 13, 'to': 15, 'guard': "(> nr1 nr0)"})
...
rules.append({'idx': 42, 'from': 24, 'to': 26, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 43, 'from': 24, 'to': 27, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 44, 'from': 24, 'to': 28, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 (* 2 tb) to)) )"})
rules.append({'idx': 45, 'from': 24, 'to': 29, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 (* 2 tb) to)) )"})

rules.append({'idx': 46, 'from': 25, 'to': 26, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 47, 'from': 25, 'to': 27, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 (* 2 tb) to)) )"})
rules.append({'idx': 48, 'from': 25, 'to': 28, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 (* 2 tb) to)) )"})
rules.append({'idx': 49, 'from': 25, 'to': 29, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 (* 2 tb) to)) )"})

rules.append({'idx': 50, 'from': 26, 'to': 30, 'guard': "(> nrq0 0)"})
rules.append({'idx': 51, 'from': 26, 'to': 31, 'guard': "(> nrq1 0)"})

rules.append({'idx': 52, 'from': 27, 'to': 32, 'guard': "true"})

rules.append({'idx': 53, 'from': 28, 'to': 33, 'guard': "(> nrq0 0)"})
rules.append({'idx': 54, 'from': 28, 'to': 34, 'guard': "(> nrq1 0)"})
...
rules.append({'idx': 68, 'from': 36, 'to': 38, 'guard': "(<= nr1 nr0)"})
rules.append({'idx': 69, 'from': 36, 'to': 39, 'guard': "(> nr1 nr0)"})

rules.append({'idx': 70, 'from': 37, 'to': 38, 'guard': "(<= nr1 nr0)"})
rules.append({'idx': 71, 'from': 37, 'to': 39, 'guard': "(> nr1 nr0)"})
...
rules.append({'idx': 76, 'from': 2, 'to': 6, 'guard': "(and (= nrq0 0) (= nrq1 0))"})
rules.append({'idx': 77, 'from': 4, 'to': 9, 'guard': "(and (= nrq0 0) (= nrq1 0))"})

rules.append({'idx': 78, 'from': 26, 'to': 30, 'guard': "(and (= nrq0 0) (= nrq1 0))"})
rules.append({'idx': 79, 'from': 28, 'to': 33, 'guard': "(and (= nrq0 0) (= nrq1 0))"})
...
environment.append('(<= nrq0 (+ q0 qo0 qb))')
environment.append('(>= nrq1 q1)')
environment.append('(<= nrq1 (+ q1 qo1 qb))')

environment.append('(= (+ q0 q1 qo0 qo1 qb) 1)')
