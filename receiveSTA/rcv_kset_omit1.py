...
# rules
rules = []
rules.append({'idx': 0, 'from': 0, 'to': 0, 'guard': "(< nr1 1)"})
rules.append({'idx': 1, 'from': 1, 'to': 0, 'guard': "(>= nr0 1)"})
rules.append({'idx': 2, 'from': 1, 'to': 1, 'guard': "(< nr0 1)"})
rules.append({'idx': 3, 'from': 0, 'to': 1, 'guard': "(>= nr1 1)"})

rules.append({'idx': 4, 'from': 0, 'to': 4, 'guard': "(< nr1 1)"})
rules.append({'idx': 5, 'from': 4, 'to': 0, 'guard': "(< nr1 1)"})

rules.append({'idx': 6, 'from': 1, 'to': 4, 'guard': "(>= nr0 1)"})
rules.append({'idx': 7, 'from': 5, 'to': 0, 'guard': "(>= nr0 1)"})

rules.append({'idx': 8, 'from': 1, 'to': 5, 'guard': "(< nr0 1)"})
rules.append({'idx': 9, 'from': 5, 'to': 1, 'guard': "(< nr0 1)"})

rules.append({'idx': 10, 'from': 0, 'to': 5, 'guard': "(>= nr1 1)"})
rules.append({'idx': 11, 'from': 4, 'to': 1, 'guard': "(>= nr1 1)"})

rules.append({'idx': 12, 'from': 2, 'to': 2, 'guard': "(< nr1 1)"})
rules.append({'idx': 13, 'from': 3, 'to': 2, 'guard': "(>= nr0 1)"})
rules.append({'idx': 14, 'from': 3, 'to': 3, 'guard': "(< nr0 1)"})
rules.append({'idx': 15, 'from': 2, 'to': 3, 'guard': "(>= nr1 1)"})

rules.append({'idx': 16, 'from': 2, 'to': 6, 'guard': "(< nr1 1)"})
rules.append({'idx': 17, 'from': 6, 'to': 2, 'guard': "(< nr1 1)"})

rules.append({'idx': 18, 'from': 3, 'to': 6, 'guard': "(>= nr0 1)"})
rules.append({'idx': 19, 'from': 7, 'to': 2, 'guard': "(>= nr0 1)"})

rules.append({'idx': 20, 'from': 3, 'to': 7, 'guard': "(< nr0 1)"})
rules.append({'idx': 21, 'from': 7, 'to': 3, 'guard': "(< nr0 1)"})

rules.append({'idx': 22, 'from': 2, 'to': 7, 'guard': "(>= nr1 1)"})
rules.append({'idx': 23, 'from': 6, 'to': 3, 'guard': "(>= nr1 1)"})
