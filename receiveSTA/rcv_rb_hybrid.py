...
rules.append({'idx': 1, 'from': 0, 'to': 2, 'guard': "(>= nr (- n (* 2 tb) (* 2 to)))"}) 
rules.append({'idx': 2, 'from': 1, 'to': 2, 'guard': "(< nr (- n tb to))"})
rules.append({'idx': 3, 'from': 2, 'to': 2, 'guard': "(< nr (- n tb to))"})
rules.append({'idx': 4, 'from': 2, 'to': 3, 'guard': "(>= nr (- n tb to))"})
rules.append({'idx': 5, 'from': 3, 'to': 3, 'guard': "true"})
rules.append({'idx': 6, 'from': 0, 'to': 3, 'guard': "(>= nr (- n tb to))"})
rules.append({'idx': 7, 'from': 1, 'to': 3, 'guard': "(>= nr (- n tb to))"})

rules.append({'idx': 8, 'from': 4, 'to': 4, 'guard': "(< nr (- n (* 2 tb) (* 2 to)))"})
rules.append({'idx': 9, 'from': 4, 'to': 6, 'guard': "(>= nr (- n (* 2 tb) (* 2 to)))"})
rules.append({'idx': 10, 'from': 5, 'to': 6, 'guard': "(< nr (- n tb to))"})
rules.append({'idx': 11, 'from': 6, 'to': 6, 'guard': "(< nr (- n tb to))"})
rules.append({'idx': 12, 'from': 6, 'to': 7, 'guard': "(>= nr (- n tb to))"})
rules.append({'idx': 13, 'from': 7, 'to': 7, 'guard': "true"})
rules.append({'idx': 14, 'from': 4, 'to': 7, 'guard': "(>= nr (- n tb to))"})
rules.append({'idx': 15, 'from': 5, 'to': 7, 'guard': "(>= nr (- n tb to))"})
