...
rules = []
rules.append({'idx': 0, 'from': 0, 'to': 2, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 to)) )"})
rules.append({'idx': 1, 'from': 0, 'to': 3, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 to)) )"})
rules.append({'idx': 2, 'from': 0, 'to': 4, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 to)) )"})
rules.append({'idx': 3, 'from': 0, 'to': 5, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 to)) )"})

rules.append({'idx': 4, 'from': 1, 'to': 2, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 to)) )"})
rules.append({'idx': 5, 'from': 1, 'to': 3, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 to)) )"})
rules.append({'idx': 6, 'from': 1, 'to': 4, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 to)) )"})
rules.append({'idx': 7, 'from': 1, 'to': 5, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 to)) )"})
...
rules.append({'idx': 34, 'from': 18, 'to': 20, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 to)) )"})
rules.append({'idx': 35, 'from': 18, 'to': 21, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 to)) )"})
rules.append({'idx': 36, 'from': 18, 'to': 22, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 to)) )"})
rules.append({'idx': 37, 'from': 18, 'to': 23, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 to)) )"})

rules.append({'idx': 38, 'from': 19, 'to': 20, 'guard': "(and (<= nr1 nr0) (<= nr0 (+ nr1 to)) )"})
rules.append({'idx': 39, 'from': 19, 'to': 21, 'guard': "(and (<= nr1 nr0) (> nr0 (+ nr1 to)) )"})
rules.append({'idx': 40, 'from': 19, 'to': 22, 'guard': "(and (> nr1 nr0) (<= nr1 (+ nr0 to)) )"})
rules.append({'idx': 41, 'from': 19, 'to': 23, 'guard': "(and (> nr1 nr0) (> nr1 (+ nr0 to)) )"})

rules.append({'idx': 42, 'from': 20, 'to': 24, 'guard': "(> nrq0 0)"})
rules.append({'idx': 43, 'from': 20, 'to': 25, 'guard': "(> nrq1 0)"})

rules.append({'idx': 44, 'from': 21, 'to': 26, 'guard': "true"})

rules.append({'idx': 45, 'from': 22, 'to': 27, 'guard': "(> nrq0 0)"})
rules.append({'idx': 46, 'from': 22, 'to': 28, 'guard': "(> nrq1 0)"})
...
rules.append({'idx': 60, 'from': 30, 'to': 32, 'guard': "(<= nr1 nr0)"})
rules.append({'idx': 61, 'from': 30, 'to': 32, 'guard': "(> nr1 nr0)"})

rules.append({'idx': 62, 'from': 31, 'to': 32, 'guard': "(<= nr1 nr0)"})
rules.append({'idx': 63, 'from': 31, 'to': 32, 'guard': "(> nr1 nr0)"})
...
rules.append({'idx': 68, 'from': 2, 'to': 6, 'guard': "(and (= nrq0 0) (= nrq1 0))"})
rules.append({'idx': 69, 'from': 4, 'to': 9, 'guard': "(and (= nrq0 0) (= nrq1 0))"})

rules.append({'idx': 70, 'from': 20, 'to': 24, 'guard': "(and (= nrq0 0) (= nrq1 0))"})
rules.append({'idx': 71, 'from': 22, 'to': 27, 'guard': "(and (= nrq0 0) (= nrq1 0))"})
...
environment.append('(<= nrq0 (+ q0 qo0))')
environment.append('(>= nrq1 q1)')
environment.append('(<= nrq1 (+ q1 qo1))')

environment.append('(= (+ q0 q1 qo0 qo1) 1)')
