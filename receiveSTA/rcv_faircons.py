...
rules.append({'idx': 1, 'from': 1, 'to': 4, 'guard': "(< nr0 1)"})
rules.append({'idx': 2, 'from': 1, 'to': 3, 'guard': "(>= nr0 1)"})
rules.append({'idx': 3, 'from': 2, 'to': 2, 'guard': "true"})
rules.append({'idx': 4, 'from': 4, 'to': 4, 'guard': "(< nr0 1)"})
rules.append({'idx': 5, 'from': 4, 'to': 3, 'guard': "(>= nr0 1)"})
rules.append({'idx': 6, 'from': 3, 'to': 2, 'guard': "true"})
rules.append({'idx': 7, 'from': 0, 'to': 7, 'guard': "true"})
rules.append({'idx': 8, 'from': 1, 'to': 9, 'guard': "(< nr0 1)"})
rules.append({'idx': 9, 'from': 1, 'to': 8, 'guard': "(>= nr0 1)"})
rules.append({'idx': 10, 'from': 2, 'to': 7, 'guard': "true"})
rules.append({'idx': 11, 'from': 4, 'to': 9, 'guard': "(< nr0 1)"})
rules.append({'idx': 12, 'from': 4, 'to': 8, 'guard': "(>= nr0 1)"})
