...
# rules
rules = []
rules.append({'idx': 0, 'from': 0, 'to': 2, 'guard': "(and (<= nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 1, 'from': 0, 'to': 3, 'guard': "(and (<= nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})
rules.append({'idx': 2, 'from': 0, 'to': 4, 'guard': "(and (> nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 3, 'from': 0, 'to': 5, 'guard': "(and (> nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})

rules.append({'idx': 4, 'from': 1, 'to': 2, 'guard': "(and (<= nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 5, 'from': 1, 'to': 3, 'guard': "(and (<= nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})
rules.append({'idx': 6, 'from': 1, 'to': 4, 'guard': "(and (> nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 7, 'from': 1, 'to': 5, 'guard': "(and (> nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})

rules.append({'idx': 8, 'from': 2, 'to': 6, 'guard': "(and (<= nrm1 tb) (<= nrm0 (* 2 tb)) )"})
rules.append({'idx': 9, 'from': 2, 'to': 7, 'guard': "(and (<= nrm1 tb) (> nrm0 (* 2 tb)) )"})
rules.append({'idx': 10, 'from': 2, 'to': 8, 'guard': "(and (> nrm1 tb) (<= nrm1 (* 2 tb)) )"})
rules.append({'idx': 11, 'from': 2, 'to': 9, 'guard': "(and (> nrm1 tb) (> nrm1 (* 2 tb)) )"})

rules.append({'idx': 12, 'from': 3, 'to': 6, 'guard': "(and (<= nrm1 tb) (<= nrm0 (* 2 tb)) )"})
rules.append({'idx': 13, 'from': 3, 'to': 7, 'guard': "(and (<= nrm1 tb) (> nrm0 (* 2 tb)) )"})
rules.append({'idx': 14, 'from': 3, 'to': 8, 'guard': "(and (> nrm1 tb) (<= nrm1 (* 2 tb)) )"})
rules.append({'idx': 15, 'from': 3, 'to': 9, 'guard': "(and (> nrm1 tb) (> nrm1 (* 2 tb)) )"})

rules.append({'idx': 16, 'from': 4, 'to': 6, 'guard': "(and (<= nrm1 tb) (<= nrm0 (* 2 tb)) )"})
rules.append({'idx': 17, 'from': 4, 'to': 7, 'guard': "(and (<= nrm1 tb) (> nrm0 (* 2 tb)) )"})
rules.append({'idx': 18, 'from': 4, 'to': 8, 'guard': "(and (> nrm1 tb) (<= nrm1 (* 2 tb)) )"})
rules.append({'idx': 19, 'from': 4, 'to': 9, 'guard': "(and (> nrm1 tb) (> nrm1 (* 2 tb)) )"})

rules.append({'idx': 20, 'from': 5, 'to': 6, 'guard': "(and (<= nrm1 tb) (<= nrm0 (* 2 tb)) )"})
rules.append({'idx': 21, 'from': 5, 'to': 7, 'guard': "(and (<= nrm1 tb) (> nrm0 (* 2 tb)) )"})
rules.append({'idx': 22, 'from': 5, 'to': 8, 'guard': "(and (> nrm1 tb) (<= nrm1 (* 2 tb)) )"})
rules.append({'idx': 23, 'from': 5, 'to': 9, 'guard': "(and (> nrm1 tb) (> nrm1 (* 2 tb)) )"})
...
# king transitions
rules.append({'idx': 42, 'from': 16, 'to': 18, 'guard': "(and (<= nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 43, 'from': 16, 'to': 19, 'guard': "(and (<= nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})
rules.append({'idx': 44, 'from': 16, 'to': 20, 'guard': "(and (> nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 45, 'from': 16, 'to': 21, 'guard': "(and (> nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})

rules.append({'idx': 46, 'from': 17, 'to': 18, 'guard': "(and (<= nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 47, 'from': 17, 'to': 19, 'guard': "(and (<= nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})
rules.append({'idx': 48, 'from': 17, 'to': 20, 'guard': "(and (> nr0 (+ nr1 tb)) (<= nr1 (+ nr0 tb)) )"})
rules.append({'idx': 49, 'from': 17, 'to': 21, 'guard': "(and (> nr0 (+ nr1 tb)) (> nr1 (+ nr0 tb)) )"})

rules.append({'idx': 50, 'from': 18, 'to': 22, 'guard': "(<= nrm1 tb)"})
rules.append({'idx': 51, 'from': 18, 'to': 23, 'guard': "(> nrm1 tb)"})
...
rules.append({'idx': 72, 'from': 6, 'to': 10, 'guard': "(and (= nrk0 0) (= nrk1 0))"})
rules.append({'idx': 73, 'from': 8, 'to': 14, 'guard': "(and (= nrk0 0) (= nrk1 0))"})
...
environment.append('(<= nr0 (+ x0 fb))')
environment.append('(>= nr1 x1)')
environment.append('(<= nr1 (+ x1 fb))')

environment.append('(>= nrm0 m0)')
environment.append('(<= nrm0 (+ m0 fb))')
environment.append('(>= nrm1 m1)')
environment.append('(<= nrm1 (+ m1 fb))')
