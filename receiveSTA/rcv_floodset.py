...
rules.append({'idx': 1, 'from': 0, 'to': 2, 'guard': "(>= nr1 1)"})
rules.append({'idx': 2, 'from': 2, 'to': 2, 'guard': "true"})
rules.append({'idx': 3, 'from': 1, 'to': 2, 'guard': "(>= nr0 1)"})
rules.append({'idx': 4, 'from': 1, 'to': 1, 'guard': "(< nr0 1)"})
rules.append({'idx': 5, 'from': 0, 'to': 3, 'guard': "(< nr1 1)"})
rules.append({'idx': 6, 'from': 0, 'to': 5, 'guard': "(>= nr1 1)"})
rules.append({'idx': 7, 'from': 2, 'to': 5, 'guard': "true"})
rules.append({'idx': 8, 'from': 1, 'to': 5, 'guard': "(>= nr0 1)"})
rules.append({'idx': 9, 'from': 1, 'to': 4, 'guard': "(< nr0 1)"})
