...
rules.append({'idx': 4, 'from': 2, 'to': 1, 'guard': "(and (< nr0 1) (>= nr1 1))"})
rules.append({'idx': 5, 'from': 2, 'to': 2, 'guard': "(and (< nr0 1) (< nr1 1))"})

rules.append({'idx': 6, 'from': 3, 'to': 3, 'guard': "true"})
rules.append({'idx': 7, 'from': 4, 'to': 3, 'guard': "(>= nr0 1)"})
rules.append({'idx': 8, 'from': 4, 'to': 4, 'guard': "(< nr0 1)"})
rules.append({'idx': 9, 'from': 5, 'to': 3, 'guard': "(>= nr0 1)"})
rules.append({'idx': 10, 'from': 5, 'to': 4, 'guard': "(and (< nr0 1) (>= nr1 1))"})
rules.append({'idx': 11, 'from': 5, 'to': 5, 'guard': "(and (< nr0 1) (< nr1 1))"})
